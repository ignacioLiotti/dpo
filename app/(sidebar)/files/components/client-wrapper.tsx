          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <div className={cn("p-2 rounded-lg bg-primary/10", currentFolder && "py-3")}>
                {currentFolder ? (
                  <div className="group cursor-default hover:bg-muted transition-colors">
              ...
              <div className="flex flex-col items-start justify-between w-full">
                <h2 className="text-xl font-semibold flex items-center justify-between gap-2 w-full">
                  {currentFolder ? currentFolder.name : 'Files'}
                  {currentFolder && (
                    <Button variant="ghost" size="icon" className="w-6 h-6" onClick={() => setShowSettings(true)}>
                      <Settings />
                    </Button>
                  )}
                </h2>
                  ...
                  <AnimatePresence mode="wait">
                    {view === 'table' ? (
                      <motion.div
                        ...
                        transition={{ duration: 0.2 }}
                      >
                        <DocumentTableView documents={documents} folders={folders} />
                      </motion.div>
                    ) : (
                      <motion.div
                        key="cards"
